using Issue698_4_1_1_Working.Infrastructure.Configuration;
...
namespace Issue698_4_1_1_Working
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, VersionedODataModelBuilder modelBuilder)
        {
            app
                ...
                .UseForwardedHeaders()
                .UseWhen(ctx => ctx.Request.Path.Value.StartsWith("/issue698_411_working/v"), api =>
                {
                    api
                ...
                .UseMvc(route => route
                    ...
                    .MapVersionedODataRoutes(
                        "odata",
                        "issue698_411_working/v{version:apiVersion}",
